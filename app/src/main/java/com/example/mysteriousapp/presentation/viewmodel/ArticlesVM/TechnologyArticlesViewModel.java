...
public class TechnologyArticlesViewModel extends ArticlesViewModel {
    ...
    public TechnologyArticlesViewModel(ArticleRepository articleRepository) {
    ...
    public void getArticles() {
        ...
        compositeDisposable.add(articleRepository.getTechnologyArticles(ArticleApplication.API_KEY)
