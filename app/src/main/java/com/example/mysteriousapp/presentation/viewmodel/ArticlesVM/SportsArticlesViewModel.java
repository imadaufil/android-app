...
public class SportsArticlesViewModel extends ArticlesViewModel {
    ...
    public SportsArticlesViewModel(ArticleRepository articleRepository) {
    ...
    public void getArticles() {
        ...
        compositeDisposable.add(articleRepository.getSportsArticles(ArticleApplication.API_KEY)
